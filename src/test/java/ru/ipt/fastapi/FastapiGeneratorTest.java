 ...
 * 1) Set a break point in FastapiGenerator.java in the postProcessOperationsWithModels() method.
...
public class FastapiGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("fastapi") // use this codegen library
              .setInputSpec("/Users/kuznetsov/ipt/megafon_billing_facade/specs/openapi.yaml") // sample OpenAPI file
              // .setInputSpec("https://raw.githubusercontent.com/openapitools/openapi-generator/master/modules/openapi-generator/src/test/resources/2_0/petstore.yaml") // or from the server
              .setOutputDir("out/fastapi"); // output directory

    final ClientOptInput clientOptInput = configurator.toClientOptInput();
    DefaultGenerator generator = new DefaultGenerator();
    System.out.println(generator.opts(clientOptInput).generate());
  }
}